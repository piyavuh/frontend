...
import Buycowcredit from '../../../containers/General-product/BuyCow/BuyCowCredit/Buycowcredit';
import Backmenubar from '../../../containers/General-product/BuyCow/BuyCowCredit/back-menu';
...
export default class BuyCowCredit extends Component {
    render() {
        return (
            <div>
                 <Layout>
            ...
            <div className='E-header ' style={{marginTop:'40px'}}>
                <c>กรอกข้อมูลการซื้อโคสินเชื่อ</c>
                        </div>
