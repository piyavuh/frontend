...
import Medicinecowcredit from '../../../containers/General-product/MedicineCow/MedicineCowCredit/medicinecredit';
import Backmenubar from '../../../containers/General-product/MedicineCow/MedicineCowCredit/back-menu';
...
export default class MedicineCowCredit extends Component {
    render() {
        return (
            <div>
                 <Layout>
            ...
            <div className='E-header ' style={{marginTop:'40px'}}>
                <c>กรอกข้อมูลการซื้อยารักษาโรคโค</c>
                        </div>
