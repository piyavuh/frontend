...
import Foodcowcash from '../../../containers/General-product/FoodCow/FoodCowCash/foodcowcash';
import Backmenubar from '../../../containers/General-product/FoodCow/FoodCowCash/back-menu';
...
export default class Buyfoodcash extends Component {
    render() {
        return (
            <div>
                 <Layout>
