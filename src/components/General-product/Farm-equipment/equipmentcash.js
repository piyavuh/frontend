...
import Equipmentcash from '../../../containers/General-product/Farm-equipment/equipmentcash/equipmentcash';
import Backmenubar from '../../../containers/General-product/Farm-equipment/equipmentcash/back-menu';
...
export default class Buyequipmentcash extends Component {
    render() {
        return (
            <div>
                 <Layout>
