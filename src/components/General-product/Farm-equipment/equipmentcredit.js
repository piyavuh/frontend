...
import Equipmentcredit from '../../../containers/General-product/Farm-equipment/equipmentcredit/equipmentcredit';
import Backmenubar from '../../../containers/General-product/Farm-equipment/equipmentcredit/back-menu';
...
export default class Buyequipmentcredit extends Component {
    render() {
        return (
            <div>
                 <Layout>
            ...
            <div className='E-header ' style={{marginTop:'40px'}}>
                <c>กรอกข้อมูลการซื้ออุปกรณ์ฟาร์ม</c>
                        </div>
