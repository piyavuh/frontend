       ...
       >
         ...
         <SubMenu
          ...
          <SubMenu  
            ...
            title={
              <span>
                <span className='box-menu2'>ซื้อน้ำเชื้อโค</span>
              </span>
            }
          >
          ...
          <SubMenu
            ...
            title={
              <span>
                <span className='box-menu2'>ซื้ออาหารโค</span>
              </span>
            }
          >
            <Barmenu>
            <Menu  className='box-menu'  >
              ...
              <span className='box-menu2'>ซื้ออาหารเงินสด</span>
              </Link>
              </Menu.Item>

              <Menu.Item  key="ซื้ออาหารสินเชื้อ">
              <Link to='/foodcow-credit'> 
              <span className='box-menu2'>ซื้ออาหารสินเชื้อ</span>
              </Link>
              </Menu.Item>
          ...
          <SubMenu
            ...
            title={
              <span>
                <span className='box-menu2'>ซื้อยารักษาโรคโค</span>
              </span>
            }
          >
              <Barmenu>
          ...
          <SubMenu
            ...
            title={
              <span>
                <span className='box-menu2'>ซื้ออุปกรณ์ในฟาร์ม</span>
              </span>
            }
          >
              <Barmenu>
