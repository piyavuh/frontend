...
import Tableequipmentcredit from './Table_equipmentcredit';
import styled from 'styled-components';



class Buyequipmentcredit extends Component {
        ...
        return (
            ...
            <Thing>
             <div className="modal-header" >  
                  <c >ซื้ออุปกรณ์ฟาร์มสินเชื่อ</c>
             </div>
              <div className="modal-content " >
                             
              <Tableequipmentcredit/>
...
export default  Buyequipmentcredit;
