        ...
        return (
            <Thing>
                ...
                <Col  span={4}>
                        ...
                        <Col span={4}>
                            <div style={style}>
                            <label  style={{fontSize:'3ch',color:'black'}}><c style={{color:'red'}}>* </c> วัน/เดือน/ปีเกิด :</label>
                                <Form.Item 
                                name={['birthday']} 
                                label="" 
                    ...
                    <Row gutter={22} style={{paddingBottom:'10px'}}>
                        ...
                        >
                             <Col span={4}>
                                <div style={style}>
                                    <Input.Password placeholder="๊ยืนยันรหัสผ่าน" style={{width:'600%',fontSize:'2.4ch', borderRadius: '0.5em'}} />
                                </div>
                             </Col>
                        </Form.Item>  
                        </div>                        
