...
import Backapprove from '../../containers/Approve/back-approve';
import Tableapprove from '../../containers/Approve/Table_approve';
...
export default class BlackList_page extends Component {
    render() {
        return (
            <div>
                 <Layout>
            ...
            <div className='E-header ' style={{marginTop:'40px'}}>
                <c>อนุมัติ/ไม่อนุมัติ</c>
                        ...
                        <Col className="gutter-row" span={6}>
                            ...
                            allowClear
                            >
                            <Option style={{fontSize:'3ch'}} value="member_code">รหัสสมาชิก</Option>
                            <Option style={{fontSize:'3ch'}} value="name">ชื่อ</Option>
                            <Option style={{fontSize:'3ch'}} value="lasname">นามสกุล</Option>
                            </Select>
