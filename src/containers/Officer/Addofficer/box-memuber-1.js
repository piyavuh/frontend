                    ...
                    <Col span={4}>
                      <div style={style}>
                        <Input
                          ...
                          style={{ width: "600%", borderRadius: "0.5em" }}
                        />
                      </div>
                    </Col>
                  </Form.Item>
              ...
              <Col span={4}>
                <div style={style}>
                  ...
                  <Form.Item
                    name="gender"
                    rules={[
                      { required: true, message: "กรูณาเลือกเพศของท่าน" },
                    ]}
                  >
                    <Col>
                      <div style={style}>
                        <Radio.Group>
                          <Radio style={{ fontSize: "3ch" }} value="male">
                            เพศชาย
                          </Radio>
                          <Radio style={{ fontSize: "3ch" }} value="female">
                            เพศหญิง
                          </Radio>
                        </Radio.Group>
                      </div>
              ...
              <Col span={4}>
                <div style={style}>
                  ...
                  <Form.Item
                    ...
                    label=""
                    rules={[
                      { required: true, message: "กรูณาระบุวันเกิดของท่าน" },
                    ]}
                  >
                    <Col>
                      <div style={style}>
            ...
            <Row gutter={22} style={{ paddingBottom: "10px" }}>
              ...
              <Col span={4}>
                <div style={style}>
                  ...
                  <Form.Item name="E-mail" rules={[{ required: false }]}>
                    <Col span={4}>
                      <div style={style}>
                        <Input
            ...
            <Row gutter={22} style={{ paddingBottom: "10px" }}>
              ...
              <Col span={4}>
                <div style={style}>
                  ...
                  <Form.Item
                    name="phone"
                    rules={[
                      { required: true, message: "กรุณากรอกเบอร์โทรศพท์" },
                    ]}
                    hasFeedback
                  >
                    <Col span={4}>
              ...
              <Col span={4}>
                <div style={style}>
                  ...
                  <Form.Item name="facebook" rules={[{ required: false }]}>
                    <Col span={4}>
                      <div style={style}>
                        <Input
              ...
              <Col span={4}>
                <div style={style}>
                  ...
                  <Form.Item name="id_line" rules={[{ required: false }]}>
                    <Col span={4}>
                      <div style={style}>
                        <Input
