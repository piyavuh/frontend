...
export default class Equipmentregistered extends Component {
  render() {
    return (
      <Thing>
        <Form>
          <div className="modal-header" >
            <c ><FontAwesomeIcon style={{color:'white'}} icon={faListAlt} /> ข้อมูลวัสดุ/อุปกรณ์</c>
          </div>
          <div className="modal-content " >
            ...
            <Col style={{ textAlign: 'right', paddingBottom: '20px' }}>
              <Form.Item >
                <Button style={{ fontSize: '3.5ch', marginLeft: '10px',backgroundColor:'#4CAF50',color:'white',border:'#4CAF50' }}  htmlType="submit">
                  บันทึกข้อมูล
                           </Button>
